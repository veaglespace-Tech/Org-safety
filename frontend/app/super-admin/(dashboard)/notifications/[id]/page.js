...
import { ArrowLeft, Calendar, Loader2, Megaphone, FileText, BarChart2, Trophy, Paperclip, Building2 } from "lucide-react";
...
export default function SuperAdminNotificationDetailPage() {
  const { id } = useParams();
